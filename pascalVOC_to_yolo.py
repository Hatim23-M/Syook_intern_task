...
Arguments:
    ...
    output_dir_ppe (str): The directory where YOLO annotations for 'ppe' (personal protective equipment) will be saved.
...
(There are 2 output directories. The first directory, where the bbox data of person is stored. This data is used to train the person detection model.
The second directory contains the bbox and class ids of various equipments present on the person. This data is used to train the second model that
detects objects.)
